            ...
            <div class="col-10">
                ...
                <form action="{{ route('users.store') }}" method="POST" class="needs-validation row g-3" novalidate >
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <input class="form-check-input " type="radio" name="hostel" id="hostel_yes" value="yes" {{ old('hostel') == 'yes' ? 'checked' : '' }} required>
                        <label class="form-check-label" for="hostel_yes">Yes</label>
                        </div>
                        <div class="form-check form-check-inline fix-position">
                        <input class="form-check-input " type="radio" name="hostel" id="hostel_no" value="no" {{ old('hostel') == 'no' ? 'checked' : '' }} required>
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <input class="form-check-input" type="checkbox" name="subjects[]" id="subject1" value="Cyber Security" {{ in_array('subject1', old('subjects', [])) ? 'checked' : '' }}> Cyber Security
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="subjects[]" id="subject2" value="Artificial Inteligence" {{ in_array('subject2', old('subjects', [])) ? 'checked' : '' }}> Artificial Inteligence
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="subjects[]" id="subject3" value="Block Chain" {{ in_array('subject3', old('subjects', [])) ? 'checked' : '' }}> Block Chain
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="subjects[]" id="subject4" value="IOT" {{ in_array('subject4', old('subjects', [])) ? 'checked' : '' }}> IOT
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="subjects[]" id="subject5" value="ROBOTICS" {{ in_array('subject5', old('subjects', [])) ? 'checked' : '' }}> ROBOTICS
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6" >
